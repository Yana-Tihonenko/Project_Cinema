...
public class TableGenerator {
  ...
  /**
   * Функция выводит в консоль данные в табличном представлении.
   *
   * @param headersList список список заголовков таблицы
   * @param rowsList    список данных для табличного представления
   */
